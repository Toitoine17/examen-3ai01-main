        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <p>
                        Le nombre aléatoire est : <?php echo e($numbers); ?>
                    ...
                    <p>
                        Suite de Fibonacci jusqu'à 63245986 :
                        <?php
                            $fibonacci = [0, 1];
                            $i = 2;

                            while (end($fibonacci) < 63245986) {
...
<?php /**PATH C:\Users\Antoi\Downloads\examen-3ai01-main\resources\views/step9.blade.php ENDPATH**/ ?>