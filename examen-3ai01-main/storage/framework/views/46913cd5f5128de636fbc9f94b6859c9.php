    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="max-w-7xl mx-auto p-6 lg:p-8">
                    <div class="flex justify-center">
                        <h1 class="text-3xl font-semibold mb-6">Rick and Morty Characters</h1>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        <?php $__currentLoopData = $characters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $character): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-lg shadow p-6">
                                ...
                                <img src="<?php echo e($character['image']); ?>" alt="<?php echo e($character['name']); ?>" class="w-full mb-2">
                                <p class="text-gray-600"><?php echo e($character['species']); ?></p>
                            </div>
...
<?php /**PATH C:\Users\Antoi\Downloads\examen-3ai01-main\resources\views/step4.blade.php ENDPATH**/ ?>