...
<head>
    ...
    {{--      @dd("Je ne devrais pas apparaitre, mais où suis-je? Si tu me vois, c'est que tu dois corriger le code... ") --}}
    <!-- Styles -->
    <style>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="{{ route($next) }}"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{ $title }}
                            </h2>
